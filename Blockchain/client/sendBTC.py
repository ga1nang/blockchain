...
class SendBTC:
    #UTXOS is unspent transactions, miner will check this, check for enough coin
    ...
    def scriptPubKey(self, PublicAddress):
        ...
        srcipt_pubkey = Script().p2pkh_script(h160)
        return srcipt_pubkey


    def getPrivateKey(self):
        AllAccount = AccountDB().read()
